...
!!! note "Notes:"
    ...
    3. The `google_search` argument is enabled by default for all requests, setting the referer to `https://www.google.com/`. If `extra_headers` contains a Referer header, the user-supplied Referer takes priority.
